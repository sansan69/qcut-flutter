      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(children: [
                  Icon(Icons.qr_code_scanner, size: 64, color: QCutColors.navy.withValues(alpha: 0.3)),
                  const SizedBox(height: 12),
                  Text('Scan shop QR code', style: TextStyle(color: QCutColors.charcoal.withValues(alpha: 0.5))),
                  ...
                  const SizedBox(height: 16),
                  Text('Walk-in Registration', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                ]),
              ),
            ),
            ...
            // Select barber
            Text('Select Barber', style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600, color: QCutColors.navy)),
            ...
            if (widget.barbers.isEmpty)
              Padding(
                ...
                child: Text('No barbers available', style: TextStyle(color: QCutColors.charcoal.withValues(alpha: 0.5))),
              ),
            const SizedBox(height: 24),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text('Token #${token.tokenNumber}', style: const TextStyle(fontSize: 36, fontWeight: FontWeight.bold, color: QCutColors.navy)),
                  const SizedBox(height: 8),
                  Text(token.name, style: const TextStyle(fontSize: 18)),
                  if (token.staffName != null) ...[
                    const SizedBox(height: 4),
                    Text('Barber: ${token.staffName}', style: TextStyle(color: QCutColors.charcoal.withValues(alpha: 0.6))),
                  ],
                  const SizedBox(height: 24),
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                    decoration: BoxDecoration(color: QCutColors.amberBg, borderRadius: BorderRadius.circular(20)),
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.access_time, size: 16, color: QCutColors.amber),
                      const SizedBox(width: 6),
                      Text('~15 min wait', style: TextStyle(color: QCutColors.amber, fontWeight: FontWeight.w600)),
                    ]),
                  ),
                  const SizedBox(height: 32),
                  SizedBox(
